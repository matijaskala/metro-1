...
export USE="-* bootstrap bindist nls ntpl $(portageq envvar BOOTSTRAP_USE)"
export PKGS="sys-apps/baselayout virtual/libc virtual/os-headers media-libs/harfbuzz virtual/pam sys-devel/gcc virtual/shadow sys-devel/binutils sys-apps/texinfo sys-devel/gettext sys-libs/zlib"
...
emerge $eopts --deep --newuse --oneshot $PKGS || exit 1
emerge --clean
